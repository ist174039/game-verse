...
export function AdminLoginClient() {
  ...
  return (
    <main className="relative flex min-h-svh items-center justify-center overflow-hidden bg-[#050505] px-5 py-10 text-white">
      <div className="absolute right-[-10rem] top-[-8rem] h-[560px] w-[560px] opacity-[0.06]"><Image src="/brand/clan-logo.svg" alt="" fill className="object-contain" priority /></div>
      ...
      <section className="relative w-full max-w-md rounded-2xl border border-white/[0.07] bg-[#0b0b0b]/95 p-6 shadow-[0_30px_90px_rgba(0,0,0,.55)] sm:p-8">
        ...
        <div className="mt-6 flex items-start gap-2 rounded-xl border border-primary/12 bg-primary/[0.025] p-4"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-primary"/><p className="text-xs leading-5 text-muted-foreground">O login usa Supabase Auth, mas a autorização é validada server-side pela tabela <code className="text-foreground">admin_user</code>.</p></div>
