...
import { SupabaseCompetitionDetailReadRepository } from './competition-detail-read-repository'
import { SupabaseClubOverviewReadRepository } from './club-overview-read-repository'
