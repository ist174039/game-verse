...
import type { CompetitionDetailReadRepository, CompetitionHubReadRepository, DashboardReadRepository, EconomyReadRepository, GoldCatalogReadRepository, MarketReadRepository, OnboardingReadRepository, SquadReadRepository, UniverseDirectoryReadRepository, UniverseOverviewReadRepository } from './read-repositories'
