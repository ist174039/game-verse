...
import type { ClubOverviewReadRepository, CompetitionDetailReadRepository, CompetitionHubReadRepository, DashboardReadRepository, EconomyReadRepository, GoldCatalogReadRepository, MarketReadRepository, OnboardingReadRepository, ProfileReadRepository, RankingsReadRepository, SquadReadRepository, UniverseDirectoryReadRepository, UniverseOverviewReadRepository } from './read-repositories'
