...
import type { CompetitionHubReadRepository, DashboardReadRepository, EconomyReadRepository, MarketReadRepository, OnboardingReadRepository, SquadReadRepository, UniverseDirectoryReadRepository, UniverseOverviewReadRepository } from './read-repositories'
