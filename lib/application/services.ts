...
import type { CompetitionHubReadRepository, DashboardReadRepository, EconomyReadRepository, GoldCatalogReadRepository, MarketReadRepository, OnboardingReadRepository, SquadReadRepository, UniverseDirectoryReadRepository, UniverseOverviewReadRepository } from './read-repositories'
