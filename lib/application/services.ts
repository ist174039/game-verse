...
import type { DashboardReadRepository, MarketReadRepository, OnboardingReadRepository, SquadReadRepository, UniverseDirectoryReadRepository, UniverseOverviewReadRepository } from './read-repositories'
...
export interface ApplicationServices {
  ...
  reads: { dashboard: DashboardReadRepository; onboarding: OnboardingReadRepository; universeOverview: UniverseOverviewReadRepository; universeDirectory: UniverseDirectoryReadRepository; squad: SquadReadRepository; market: MarketReadRepository }
}
